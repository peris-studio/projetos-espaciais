...
public class ApplicationDbContext : DbContext
{
    ...
    public DbSet<HistoricoAlteracao> HistoricoAlteracoes { get; set; } = null!;
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Experiencia>().HasQueryFilter(x => x.Ativo);
        ...
        modelBuilder.Entity<HistoricoAlteracao>().HasQueryFilter(x => x.Ativo);
